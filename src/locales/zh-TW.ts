export const zhTW = {
    ...
    'env.transporter': 'Transporter 服務',
    ...
    'upload.app_info_title': '應用程式資訊',
    'upload.bundle_id': 'Bundle ID',
    'upload.app_name': '名稱',
    'upload.version': '版本',
    'upload.analyzing_ipa': '正在分析 IPA...',
    ...
    'progress.cancel_confirm_title': '確認取消上傳',
    'progress.cancel_confirm_message': '上傳正在進行中，確定要取消嗎？',
    'progress.cancel_confirm_yes': '確認取消',
    'progress.cancel_confirm_no': '繼續上傳',
