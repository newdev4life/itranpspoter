...
export function Settings({ onBack }: SettingsProps) {
    ...
    const handleWebhookSave = async (url: string, enabled: boolean) => {
        await window.api.setWebhookSettings({ url, enabled })
    ...
    const handleWebhookTest = async () => {
        ...
        // Save webhook URL if test succeeds
        if (result.success) {
                ...
                <div className="settings-section">
                    <div className="section-header">
                        ...
                        <div className="section-title">
                            <h3>{t('settings.webhook_title')}</h3>
                            <p>{t('settings.webhook_desc')}</p>
                        </div>
                            ...
                            <label className="toggle-switch">
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        handleWebhookSave(webhookUrl, e.target.checked)
                                    }}
                                />
                    ...
                    <div className="webhook-url-group">
                        <label className="input-label">{t('settings.webhook_url')}</label>
                        <div className="input-row">
                            <input
                                ...
                                onBlur={() => handleWebhookSave(webhookUrl, webhookEnabled)}
                                onKeyDown={(e) => {
                                    if (e.key === 'Enter') {
                                        handleWebhookSave(webhookUrl, webhookEnabled)
                    ...
                    <div className="webhook-info">
                        ...
                        <span>{t('settings.webhook_info')}</span>
                    </div>
                </div>
            </div>
        </div>
